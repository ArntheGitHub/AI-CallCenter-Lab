...
def create_transcription_request(audio_file, speech_recognition_language="en-US"):
    ...
    transcriber.speech_start_detected.connect(lambda evt: print(f'SPEECH START DETECTED: {evt}'))
    transcriber.speech_end_detected.connect(lambda evt: print(f'SPEECH END DETECTED: {evt}'))
